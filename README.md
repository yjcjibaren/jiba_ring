...
第一关击败守门重骑士后会进入第二关。第二关定位为正式关卡，地形更长，平台落点更分散，会混合出现飞天虫、坚果怪和普通敌人，要求玩家学会保留耐力、处理空中目标，并用踩头机制快速解决高防敌人。

第二关 Boss 是紫晶魔女赛蕾娜。她的主要机制包括：

- 直线魔法：朝玩家高度释放高速魔法弹，可以通过跳跃、下落或翻滚错开弹道。
- 定位魔法：锁定玩家当前站位并生成紫色预警圈，需要及时离开原位置。
- 魔法波：二阶段后释放贴地推进的魔法波，主要惩罚站桩输出。
- 紫晶冠冕：Boss 半血左右触发大招展示立绘，随后攻速明显提高，技能衔接更紧。

游戏内 HUD 会显示玩家、仓鼠和 Boss 的具体血量数值，受击时也会在角色附近弹出本次掉血数字，方便判断伤害和药瓶使用时机。
